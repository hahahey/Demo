...
public class GaoDe2Gps {


    public static void main(String[] args) {
        LatLonPoint latLonPoint = toGPSPoint(35.688525, 111.642811);

        System.out.println(latLonPoint.getLatitude());
        System.out.println(latLonPoint.getLongitude());
...
class LatLonPoint {
    ...
    public LatLonPoint(double dLat, double dLon) {
        this.latitude = dLat;
        this.longitude = dLon;
    }
}